#!/usr/bin/env python3
"""
This module implements the Lovins stemming algorithm (1968). Use the `stem()`
function:

	stemmed_word = stem(word)

Citation: Raphaël Vinot, https://github.com/Rafiot/Stemming-Python
"""
...
# Modifying to add command line functionality
if __name__ == '__main__':
	strings = sys.argv[1:]
	for string in strings:
		tokens = string.split()
		for token in tokens:
			stemmed = stem(str(token))
			print(stemmed)
